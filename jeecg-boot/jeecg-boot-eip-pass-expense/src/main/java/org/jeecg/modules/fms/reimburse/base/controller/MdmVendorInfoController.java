...
public class MdmVendorInfoController extends JeecgController<MdmVendorInfo, IMdmVendorInfoService> {
	 ...
	 * @return
	 */
	@GetMapping(value = "/listVendorAccntByVendorcode")
	public Result<?> listVendorAccntByVendorcode(MdmVendorInfo mdmVendorInfo,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		 Page<VendorAccntVO> page = new Page<VendorAccntVO>(pageNo, pageSize);
		 LoginUser sysUser = (LoginUser) SecurityUtils.getSubject().getPrincipal();
		 Map<String,String[]> paramMap =  req.getParameterMap();
		 String vendorCode = "";
		 if(paramMap!=null) {
			 String[] args = paramMap.get("mdCode");
			 vendorCode = args!=null?args[0].trim():"";
			
		 }
		 IPage<VendorAccntVO> pageList = mdmVendorAccountInfoService.selectPageVendorAccntByVendorcodeAndOrgcode(page,vendorCode,sysUser.getOrgCode());
	 ...
	 * @return
	 */
	@GetMapping(value = "/listVendorForBiz")
	public Result<?> listVendorForBiz(MdmVendorInfo mdmVendorInfo,
								   @RequestParam(name="pageNo", defaultValue="1") Integer pageNo,
								   @RequestParam(name="pageSize", defaultValue="10") Integer pageSize,
								   HttpServletRequest req) {
		QueryWrapper<MdmVendorInfo> queryWrapper = QueryGenerator.initQueryWrapper(mdmVendorInfo, req.getParameterMap());
