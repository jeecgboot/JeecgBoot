<template>
  <a-card :bordered="false">
    ...
    <a-tabs defaultActiveKey="1">
      <a-tab-pane tab="主数据供应商归属组织" key="1" >
        <mdm-vendor-company-info-list :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="主数据供应商银行账户" key="2" forceRender>
        <mdm-vendor-account-info-list :mainId="selectedMainId" />
      </a-tab-pane>
      <a-tab-pane tab="主数据供应商联系人" key="3" forceRender>
    ...
    data () {
      return {
        ...
        columns: [
          ...
          {
            title:'纳税标识：YBNSR 一般纳税人，XGM 小规模纳税人，FZZS 非增值税',
            align:"center",
            dataIndex: 'vatFlag'
          },
          {
          ...
          {
            title:'是否上市公司：Y - 是，N - 否',
            align:"center",
            dataIndex: 'stockFlag'
          },
          {
            title:'是否内部关联方：ZB-总部,QN-其他内部关联方,WZ-外部重要关联方,QW-其他外部供应商',
            align:"center",
            dataIndex: 'innerFlag'
          },
          {
