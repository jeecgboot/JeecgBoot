...
public class LoginController {
    ...
    public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel) {
        ...
        String realKey = MD5Util.MD5Encode(sysLoginModel.getCheckKey(), "utf-8");
    ...
    public Result<Map<String, String>> getCheckCode() {
        ...
        try {
            ...
            map.put("code", encode);
            String key = MD5Util.MD5Encode(encode + System.currentTimeMillis(), "utf-8");
            redisUtil.set(key, encode, 60);
            map.put("key", key);
    ...
    public Result<String> randomImage(HttpServletResponse response, @PathVariable String key) {
        ...
        try {
            ...
            System.err.println("获取验证码2");
            System.err.println("lowerCaseCode ==" + lowerCaseCode);
            System.err.println("key ==" + key);
            System.err.println("realKey ==" + realKey);
