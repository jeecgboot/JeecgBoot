...
(function() {
  ...
  s.parentNode.insertBefore(hm, s);
		...
		<title>新闻动态_汴京茶寮官网</title>
		<link rel="icon" type="image/x-ico" href="http://www.bianjc.cn/img/favicon.ico" />
		<link rel="stylesheet" href="http://www.bianjc.cn/css/bootstrap.min.css" />
		<link rel="stylesheet" href="http://www.bianjc.cn/css/animate.min.css" />
		<link rel="stylesheet" href="http://www.bianjc.cn/css/reset.css" />
		<link rel="stylesheet" href="http://www.bianjc.cn/css/style.css" />
	...
	<body>
		<div>
			...
			<div class="content_box">
				<div class="container">
					<p class="navigation">当前位置：<a href="../..">首页</a> &gt; 新闻动态</p>
					<img class="center-block" src="../img/img_04_03.png" />
					<p class="content_tit">新闻动态</p>
							...
							<#list newList as news >
								<li>
									<div class="clearfix">
										...
										<span class="pull-right">${news.updateTimeStr}</span>
									</div>
				...
				<div class="container">
					<ul class="list-inline clearfix" >
						...
						<#list pagesList as page >
							...
							<#else>
								<li><a href="${url}/news/page_${page}.html">${page}</a></li>
							</#if>
						</#list>
						<#if downPage?? >
