	...
	<body>
		<div>
						...
						<div class="container">
							<ul class="nav navbar-nav">
									...
									<a href="../products/page_1.html" >产品中心</a>
					          					       			...
					          					       			<li  class="animated fadeInDown" >
									<a href="../shop/page_1.html" >门店展示</a>
					          	</li>
					          					       			<li  class="animated fadeInDown" >
			...
			<div class="content_box">
				<div class="container">
					<p class="navigation">当前位置：<a href="http://www.bianjc.cn/">首页</a> &gt; 门店展示</p>
					<img class="center-block" src="http://www.bianjc.cn/img/img_04_03.png" />
					<p class="content_tit">门店展示</p>
					<div class="image_box">
						<ul class="list-inline clearfix">
							<#list shopList as shop >
								<li class="col-md-3 col-xs-6 wow fadeInUp" data-wow-duration="0.5s" data-wow-delay="0" data-wow-iteration="1">
									<img src="${shop.img}"  class="img-responsive"/>
								</li>
							</#list>
						</ul>
					</div>
				...
				<div class="container">
					<div class="footer_box">
						<ul class="list-inline clearfix">
														...
														<li><a href="../shop/page.html" >门店展示</a></li>
