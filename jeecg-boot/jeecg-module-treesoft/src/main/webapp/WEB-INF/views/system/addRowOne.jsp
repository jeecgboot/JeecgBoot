		    ...
		    <c:choose>
               <c:when test="${entity.data_type == 'DATETIME' }" >  
                   ...
                   <tr>
				     ...
				     <td><input name="${entity.column_name }" type="text" class="easyui-my97" datefmt="yyyy-MM-dd HH:mm:ss"  style="width:150"  <c:if test="${entity.is_nullable == 0 }"> data-options=" required:'required' " </c:if>   /></td>
			       </tr>
