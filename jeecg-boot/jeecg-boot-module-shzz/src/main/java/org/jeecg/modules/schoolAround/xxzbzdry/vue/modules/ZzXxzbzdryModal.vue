  ...
  <a-modal
    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="户籍地" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <a-input v-decorator="[ 'hjd', validatorRules.hjd]" placeholder="请输入户籍地"></a-input>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/xxzbzdry/zzXxzbzdry/add",
          edit: "/xxzbzdry/zzXxzbzdry/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sfz','oldName','sex','photo','birthday','zm','jg','hyzk','zzmm','xl','zjxy','zylb','zy','fwcs','hjd','hjxq','xzd','xzdxq','lxfs'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sfz','oldName','sex','photo','birthday','zm','jg','hyzk','zzmm','xl','zjxy','zylb','zy','fwcs','hjd','hjxq','xzd','xzdxq','lxfs'))
      },
