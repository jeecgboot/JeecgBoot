    ...
    <a-spin :spinning="confirmLoading">
      <a-form :form="form">
        ...
        <a-form-item label="民族" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['zm', validatorRules.zm]" :trigger-change="true" dictCode="minzu" placeholder="请选择民族"/>
        </a-form-item>
        ...
        <a-form-item label="婚姻状况" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['hyzk', validatorRules.hyzk]" :trigger-change="true" dictCode="hyzk" placeholder="请选择婚姻状况"/>
        </a-form-item>
        ...
        <a-form-item label="学历" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['xl', validatorRules.xl]" :trigger-change="true" dictCode="education" placeholder="请选择学历"/>
        </a-form-item>
        ...
        <a-form-item label="流入原因" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['lryy', validatorRules.lryy]" :trigger-change="true" dictCode="lryy" placeholder="请选择流入原因"/>
        </a-form-item>
        <a-form-item label="办证类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['bzlx', validatorRules.bzlx]" :trigger-change="true" dictCode="bzlx" placeholder="请选择办证类型"/>
        </a-form-item>
        ...
        <a-form-item label="登记日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择登记日期" v-decorator="[ 'djDate', validatorRules.djDate]" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="证件到期日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-date placeholder="请选择证件到期日期" v-decorator="[ 'zjdqDate', validatorRules.zjdqDate]" :trigger-change="true" style="width: 100%"/>
        </a-form-item>
        <a-form-item label="住所类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['zslx', validatorRules.zslx]" :trigger-change="true" dictCode="zslx" placeholder="请选择住所类型"/>
        </a-form-item>
        <a-form-item label="是否重点关注" :labelCol="labelCol" :wrapperCol="wrapperCol">
          <j-dict-select-tag type="list" v-decorator="['sfZdgz', validatorRules.sfZdgz]" :trigger-change="true" dictCode="yes_no" placeholder="请选择是否重点关注"/>
        </a-form-item>
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/ldrk/zzPLdrk/add",
          edit: "/ldrk/zzPLdrk/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sfz','oldName','sex','photo','birthday','zm','jg','hyzk','zzmm','xl','zjxy','zylb','zy','hjxq','xzdxq','lxfs','lryy','bzlx','zjh','djDate','zjdqDate','zslx','sfZdgz'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sfz','oldName','sex','photo','birthday','zm','jg','hyzk','zzmm','xl','zjxy','zylb','zy','hjxq','xzdxq','lxfs','lryy','bzlx','zjh','djDate','zjdqDate','zslx','sfZdgz'))
      },
