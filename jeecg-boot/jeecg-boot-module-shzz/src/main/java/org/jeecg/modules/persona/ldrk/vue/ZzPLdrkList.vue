<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('流动人口')">导出</a-button>
    ...
    <zzPLdrk-modal ref="modalForm" @ok="modalFormOk"></zzPLdrk-modal>
  </a-card>
</template>
...
<script>
  ...
  import ZzPLdrkModal from './modules/ZzPLdrkModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/ldrk/zzPLdrk/list",
          delete: "/ldrk/zzPLdrk/delete",
          deleteBatch: "/ldrk/zzPLdrk/deleteBatch",
          exportXlsUrl: "/ldrk/zzPLdrk/exportXls",
          importExcelUrl: "ldrk/zzPLdrk/importExcel",
        },
        dictOptions:{
         sex:[],
         zm:[],
