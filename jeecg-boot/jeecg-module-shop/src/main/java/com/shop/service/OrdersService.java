...
public class OrdersService extends ServiceImpl<OrdersMapper, Orders> {
    ...
    public Map<String, String> buy(Integer productId, Integer number, String contact, Integer couponId, String payType, String password, HttpServletRequest request) {
        ...
        orders.setUsername(products.getUsername());
         ...
         * 计算手续费
         */
        Pays pays = paysMapper.selectOne(Wrappers.<Pays>lambdaQuery().eq(Pays::getDriver, orders.getPayType()).eq(Pays::getUsername,orders.getUsername()));
