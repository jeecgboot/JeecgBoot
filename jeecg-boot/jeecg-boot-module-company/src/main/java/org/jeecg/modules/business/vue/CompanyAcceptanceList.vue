<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('竣工验收信息')">导出</a-button>
    ...
    <companyAcceptance-modal ref="modalForm" @ok="modalFormOk"></companyAcceptance-modal>
  </a-card>
</template>
...
<script>
  ...
  import CompanyAcceptanceModal from './modules/CompanyAcceptanceModal'
    ...
    data () {
      return {
        ...
        url: {
          ...
          exportXlsUrl: "/business/companyAcceptance/exportXls",
          importExcelUrl: "business/companyAcceptance/importExcel",
        },
        dictOptions:{},
      }
    },
