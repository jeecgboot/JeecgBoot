...
public class SysGatewayRouteController extends JeecgController<SysGatewayRoute, ISysGatewayRouteService> {
	 ...
	 * @return
	 */
	@PreAuthorize("@jps.requiresPermissions('system:gateway:putRecycleBin')")
	 ...
	 * @return
	 */
	@PreAuthorize("@jps.requiresPermissions('system:gateway:deleteRecycleBin')")
	 ...
	 * @return
	 */
	@PreAuthorize("@jps.requiresPermissions('system:gateway:copyRoute')")
