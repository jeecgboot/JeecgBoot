...
-- =========================================================================================
-- ICEPLUMBLOSSOM.
-- @ https://github.com/iceplumblossom
-- based on the open source version--2.1.4
-- create this script for PostgreSQL 12.1
-- if you have any questions, please let me know via the following mail:
-- londontom@live.cn
-- Welcome if you upload your script for other DB(for example:DB2, SQL Server...).
-- =========================================================================================
...
CREATE TABLE "demo" (
  ...
  "punch_time" timestamp(0),
  "salary_money" numeric(10,3),
  "bonus_money" numeric(10,2),
...
INSERT INTO "demo" VALUES ('1c2ba51b29a42d9de02bbd708ea8121a', '777777', '777', '2018-12-07 19:43:17', NULL, NULL, NULL, 7, '2018-12-07 00:00:00', NULL, NULL, NULL, NULL, 'admin', '2019-02-21 18:26:04', NULL);
...
INSERT INTO "demo" VALUES ('4', 'Sandy', '开源，很好', '2018-12-15 00:00:00', NULL, NULL, '2', 21, '2018-12-15 00:00:00', 'test4@baomidou.com', '聪明00', NULL, NULL, 'admin', '2019-02-25 16:29:27', NULL);
INSERT INTO "demo" VALUES ('42c08b1a2e5b2a96ffa4cc88383d4b11', '秦50090', NULL, '2019-01-05 20:33:31', NULL, NULL, NULL, 28, '2019-01-05 00:00:00', NULL, NULL, 'admin', '2019-01-19 20:33:54', 'admin', '2019-01-19 20:34:29', NULL);
...
INSERT INTO "demo" VALUES ('5c16e6a5c31296bcd3f1053d5d118815', '导入zhangdaiscott', NULL, NULL, NULL, NULL, '1', NULL, '2019-01-03 00:00:00', NULL, NULL, 'jeecg-boot', '2019-04-10 11:42:57', 'admin', '2019-05-19 18:35:51', NULL);
INSERT INTO "demo" VALUES ('7', 'zhangdaiscott', NULL, NULL, NULL, NULL, '1', NULL, '2019-01-03 00:00:00', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
INSERT INTO "demo" VALUES ('917e240eaa0b1b2d198ae869b64a81c3', 'zhang daihao', NULL, NULL, NULL, NULL, '2', 0, '2018-11-29 00:00:00', 'zhangdaiscott@163.com', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE "joa_demo" (
  "id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "days" int8,
  "begin_date" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "end_date" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "reason" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "bpm_status" varchar(50) COLLATE "pg_catalog"."default" DEFAULT '1'::character varying,
...
CREATE TABLE "onl_cgform_button" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "button_code" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "button_icon" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "button_name" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "button_status" varchar(2) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "button_style" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "exp" varchar(255) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "cgform_head_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "opt_type" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "order_num" int8
)
;
...
CREATE TABLE "onl_cgform_enhance_java" (
  ...
  "active_status" varchar(2) COLLATE "pg_catalog"."default" DEFAULT '1'::character varying,
  "event" varchar(10) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'end'::character varying
)
;
...
CREATE TABLE "onl_cgform_enhance_js" (
  ...
  "cg_js_type" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "content" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "cgform_head_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
CREATE TABLE "onl_cgform_enhance_sql" (
  ...
  "cgb_sql_name" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "content" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "cgform_head_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
CREATE TABLE "onl_cgform_field" (
  ...
  "db_field_txt" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_field_name_old" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_is_key" int4,
  "db_is_null" int4,
  "db_type" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "db_length" int8 NOT NULL,
  "db_point_length" int8,
  "db_default_val" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "dict_field" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "dict_table" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "dict_text" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_show_type" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_href" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_length" int8,
  "field_valid_type" varchar(300) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_must_input" varchar(2) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_extend_json" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_value_rule_code" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "is_query" int4,
  "is_show_form" int4,
  "is_show_list" int4,
  "is_read_only" int4 DEFAULT 0,
  "query_mode" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "main_table" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "main_field" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "order_num" int8,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
...
COMMENT ON COLUMN "onl_cgform_field"."field_value_rule_code" IS '填值规则code';
...
CREATE TABLE "onl_cgform_head" (
  ...
  "table_type" int8 NOT NULL,
  "table_version" int8 DEFAULT 1,
  ...
  "id_sequence" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "id_type" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "query_mode" varchar(10) COLLATE "pg_catalog"."default" NOT NULL,
  "relation_type" int8,
  "sub_table_str" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "tab_order_num" int8,
  "tree_parent_id_field" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "tree_id_field" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "tree_fieldname" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "form_category" varchar(50) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'bdfl_ptbd'::character varying,
  "form_template" varchar(50) COLLATE "pg_catalog"."default",
  "form_template_mobile" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "scroll" int8 DEFAULT 0,
  "copy_version" int8,
  "copy_type" int8 DEFAULT 0,
  "physic_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "theme_template" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
CREATE TABLE "onl_cgform_index" (
  ...
  "cgform_head_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "index_name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "index_field" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "index_type" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone
)
;
...
CREATE TABLE "onl_cgreport_head" (
  ...
  "return_val_field" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "return_txt_field" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "return_type" varchar(2) COLLATE "pg_catalog"."default" DEFAULT '1'::character varying,
  "db_source" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "content" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
...
CREATE TABLE "onl_cgreport_item" (
  ...
  "field_txt" varchar(300) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_width" int4,
  "field_type" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "search_mode" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "is_order" int8 DEFAULT 0,
  "is_search" int8 DEFAULT 0,
  "dict_code" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "field_href" varchar(120) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "is_show" int8 DEFAULT 1,
  "order_num" int8,
  "replace_val" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone
...
CREATE TABLE "onl_cgreport_param" (
  ...
  "param_txt" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "param_value" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "order_num" int8,
  "create_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
...
CREATE TABLE "sys_announcement" (
  ...
  "bus_type" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "bus_id" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "open_type" varchar(20) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "open_page" varchar(255) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_by" varchar(32) COLLATE "pg_catalog"."default",
  "create_time" timestamp(0),
  "update_by" varchar(32) COLLATE "pg_catalog"."default",
  "update_time" timestamp(0),
...
CREATE TABLE "sys_announcement_send" (
  "id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "annt_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "user_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "read_flag" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "read_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone
...
CREATE TABLE "sys_category" (
  "id" varchar(36) COLLATE "pg_catalog"."default" NOT NULL,
  "pid" varchar(36) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  ...
  "update_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "sys_org_code" varchar(64) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "has_child" varchar(3) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
CREATE TABLE "sys_check_rule" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "rule_name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_code" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_json" varchar(1024) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_description" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone
...
CREATE TABLE "sys_data_source" (
  ...
  "db_type" varchar(10) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_driver" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_url" varchar(500) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_username" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "db_password" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "update_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
...
;
COMMENT ON COLUMN "sys_data_source"."id" IS 'id';
...
CREATE TABLE "sys_depart" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL DEFAULT 'sys_guid()'::character varying,
...
COMMENT ON COLUMN "sys_depart"."org_category" IS '机构类别 1组织机构，2岗位';
...
CREATE TABLE "sys_depart_permission" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "depart_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "permission_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "data_rule_ids" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
COMMENT ON COLUMN "sys_depart_permission"."id" IS 'id';
...
;
COMMENT ON COLUMN "sys_depart_role"."id" IS 'id';
...
COMMENT ON COLUMN "sys_depart_role"."create_time" IS '创建日期';
COMMENT ON COLUMN "sys_depart_role"."update_by" IS '更新人';
COMMENT ON COLUMN "sys_depart_role"."update_time" IS '更新日期';
...
CREATE TABLE "sys_depart_role_permission" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "depart_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "role_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "permission_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "data_rule_ids" varchar(1000) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
COMMENT ON COLUMN "sys_depart_role_permission"."id" IS 'id';
...
COMMENT ON COLUMN "sys_depart_role_permission"."data_rule_ids" IS 'data_rule_ids';
...
CREATE TABLE "sys_depart_role_user" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "user_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "drole_id" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying
)
;
...
COMMENT ON TABLE "sys_depart_role_user" IS '部门角色权限表';
...
CREATE TABLE "sys_dict" (
  "id" varchar(32) COLLATE "pg_catalog"."default" NOT NULL,
  "dict_name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "dict_code" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "description" varchar(255) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "del_flag" int2,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
...
CREATE TABLE "sys_fill_rule" (
  ...
  "rule_name" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_code" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_class" varchar(100) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "rule_params" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "create_by" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "create_time" timestamp(0) DEFAULT NULL::timestamp without time zone
...
-- ----------------------------
INSERT INTO "sys_permission" VALUES ('00a2a0ae65cdca5e93209cdbde97cbe6', '2e42e3835c2b44ec9f7bc26c146ee531', '成功', '/result/success', 'result/Success', NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('020b06793e4de2eee0007f603000c769', 'f0675b52d89100ee88472b6800754a08', 'ViserChartDemo', '/report/ViserChartDemo', 'jeecg/report/ViserChartDemo', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-03 19:08:53', 'admin', '2019-04-03 19:08:53', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('024f1fd1283dc632458976463d8984e1', '700b7f95165c46cc7a78bf227aa8fed3', 'Tomcat信息', '/monitor/TomcatInfo', 'modules/monitor/TomcatInfo', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-02 09:44:29', 'admin', '2019-05-07 15:19:10', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('043780fa095ff1b2bec4dc406d76f023', '2a470fc0c3954d9dbb61de6d80846549', '表格合计', '/jeecg/tableTotal', 'jeecg/TableTotal', NULL, NULL, 1, NULL, '1', 3, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-08-14 10:28:46', NULL, NULL, 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('05b3c82ddb2536a4a5ee1a4c46b5abef', '540a2936940846cb98114ffb0d145cb8', '用户列表', '/list/user-list', 'list/UserList', NULL, NULL, 1, NULL, NULL, 3, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('0620e402857b8c5b605e1ad9f4b89350', '2a470fc0c3954d9dbb61de6d80846549', '异步树列表Demo', '/jeecg/JeecgTreeTable', 'jeecg/JeecgTreeTable', NULL, NULL, 1, NULL, '0', 3, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-05-13 17:30:30', 'admin', '2019-05-13 17:32:17', 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('078f9558cdeab239aecb2bda1a8ed0d1', 'fb07ca05a3e13674dbf6d3245956da2e', '搜索列表（文章）', '/list/search/article', 'list/TableList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-12 14:00:34', 'admin', '2019-02-12 14:17:54', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('08e6b9dc3c04489c8e1ff2ce6f105aa4', '', '系统监控', '/dashboard3', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 6, 0, 'dashboard', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-31 22:19:58', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('0ac2ad938963b6c6d1af25477d5b8b51', '8d4683aacaa997ab86b966b464360338', '代码生成按钮', NULL, NULL, NULL, NULL, 2, 'online:goGenerateCode', '1', 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-06-11 14:20:09', NULL, NULL, 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('109c78a583d4693ce2f16551b7786786', 'e41b69c57a941a3bbcce45032fe57605', 'Online报表配置', '/online/cgreport', 'modules/online/cgreport/OnlCgreportHeadList', NULL, NULL, 1, NULL, NULL, 2, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-03-08 10:51:07', 'admin', '2019-03-30 19:04:28', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('1166535831146504193', '2a470fc0c3954d9dbb61de6d80846549', '对象存储', '/oss/file', 'modules/oss/OSSFileList', NULL, NULL, 1, NULL, '1', 1, 0, '', 1, 1, 0, 0, NULL, 'admin', '2019-08-28 02:19:50', 'admin', '2019-08-28 02:20:57', 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('1170592628746878978', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '菜单管理2', '/isystem/newPermissionList', 'system/NewPermissionList', NULL, NULL, 1, NULL, '1', 100, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-09-08 15:00:05', 'admin', '2019-12-25 09:58:18', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1174506953255182338', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '职务管理', '/isystem/position', 'system/SysPositionList', NULL, NULL, 1, NULL, '1', 2, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-09-19 10:14:13', 'admin', '2019-09-19 10:15:22', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1174590283938041857', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '通讯录', '/isystem/addressList', 'system/AddressList', NULL, NULL, 1, NULL, '1', 3, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-09-19 15:45:21', NULL, NULL, 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1192318987661234177', 'e41b69c57a941a3bbcce45032fe57605', '系统编码生成规则', '/isystem/fillRule', 'system/SysFillRuleList', NULL, NULL, 1, NULL, '1', 3, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-07 13:52:53', 'admin', '2020-02-23 22:42:30', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1205097455226462210', '', '大屏设计', '/big/screen', 'layouts/RouteView', NULL, NULL, 0, NULL, '1', 1, 0, 'area-chart', 1, 0, 0, 0, NULL, 'admin', '2019-12-12 20:09:58', 'admin', '2020-02-23 23:17:59', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1205098241075453953', '1205097455226462210', '生产销售监控', '{{ window._CONFIG[''domianURL''] }}/big/screen/templat/index1', 'layouts/IframePageView', NULL, NULL, 1, NULL, '1', 1, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-12-12 20:13:05', 'admin', '2019-12-12 20:15:27', 0, 0, '1', 1);
INSERT INTO "sys_permission" VALUES ('1205306106780364802', '1205097455226462210', '智慧物流监控', '{{ window._CONFIG[''domianURL''] }}/big/screen/templat/index2', 'layouts/IframePageView', NULL, NULL, 1, NULL, '1', 2, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-12-13 09:59:04', 'admin', '2019-12-25 09:28:03', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1209731624921534465', 'e41b69c57a941a3bbcce45032fe57605', '多数据源管理', '/isystem/dataSource', 'system/SysDataSourceList', NULL, NULL, 1, NULL, '1', 6, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-12-25 15:04:30', 'admin', '2020-02-23 22:43:37', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1224641973866467330', 'e41b69c57a941a3bbcce45032fe57605', '系统编码校验规则', '/isystem/checkRule', 'system/SysCheckRuleList', NULL, NULL, 1, NULL, '1', 5, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-11-07 13:52:53', 'admin', '2020-02-23 22:43:05', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('1229674163694841857', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO在线表单ERP', '/online/cgformErpList/:code', 'modules/online/cgform/auto/erp/OnlCgformErpList', NULL, NULL, 1, NULL, '1', 5, 0, NULL, 1, 1, 0, 1, NULL, 'admin', '2020-02-18 15:49:00', 'admin', '2020-02-18 15:52:25', 0, 0, '1', 0);
INSERT INTO "sys_permission" VALUES ('13212d3416eb690c2e1d5033166ff47a', '2e42e3835c2b44ec9f7bc26c146ee531', '失败', '/result/fail', 'result/Error', NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
...
INSERT INTO "sys_permission" VALUES ('190c2b43bec6a5f7a4194a85db67d96a', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '角色管理', '/isystem/roleUserList', 'system/RoleUserList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-04-17 15:13:56', 'admin', '2019-12-25 09:36:31', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('1a0811914300741f4e11838ff37a1d3a', '3f915b2769fc80648e92d04e84ca059d', '手机号禁用', NULL, NULL, NULL, NULL, 2, 'user:form:phone', '2', 1, 0, NULL, 0, 1, NULL, 0, NULL, 'admin', '2019-05-11 17:19:30', 'admin', '2019-05-11 18:00:22', 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('200006f0edf145a2b50eacca07585451', 'fb07ca05a3e13674dbf6d3245956da2e', '搜索列表（应用）', '/list/search/application', 'list/TableList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-12 14:02:51', 'admin', '2019-02-12 14:14:01', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('22d6a3d39a59dd7ea9a30acfa6bfb0a5', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO动态表单', '/online/df/:table/:id', 'modules/online/cgform/auto/OnlineDynamicForm', NULL, NULL, 1, NULL, NULL, 9, 0, NULL, 0, 1, NULL, 1, NULL, 'admin', '2019-04-22 15:15:43', 'admin', '2019-04-30 18:18:26', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('265de841c58907954b8877fb85212622', '2a470fc0c3954d9dbb61de6d80846549', '图片拖拽排序', '/jeecg/imgDragSort', 'jeecg/ImgDragSort', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-25 10:43:08', 'admin', '2019-04-25 10:46:26', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('277bfabef7d76e89b33062b16a9a5020', 'e3c13679c73a4f829bcff2aba8fd68b1', '基础表单', '/form/base-form', 'form/BasicForm', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-02-26 17:02:08', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('2a470fc0c3954d9dbb61de6d80846549', '', '常见案例', '/jeecg', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 7, 0, 'qrcode', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-04-02 11:46:42', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('2aeddae571695cd6380f6d6d334d6e7d', 'f0675b52d89100ee88472b6800754a08', '布局统计报表', '/report/ArchivesStatisticst', 'jeecg/report/ArchivesStatisticst', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-03 18:32:48', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('2dbbafa22cda07fa5d169d741b81fe12', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '在线文档', '{{ window._CONFIG[''domianURL''] }}/doc.html', 'layouts/IframePageView', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-01-30 10:00:01', 'admin', '2019-03-23 19:44:43', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('2e42e3835c2b44ec9f7bc26c146ee531', '', '结果页', '/result', 'layouts/PageView', NULL, NULL, 0, NULL, NULL, 8, 0, 'check-circle-o', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-04-02 11:46:56', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('339329ed54cf255e1f9392e84f136901', '2a470fc0c3954d9dbb61de6d80846549', 'helloworld', '/jeecg/helloworld', 'jeecg/helloworld', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-02-15 16:24:56', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('3f915b2769fc80648e92d04e84ca059d', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '用户管理', '/isystem/user', 'system/UserList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 0, 0, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-12-25 09:36:24', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('3fac0d3c9cd40fa53ab70d4c583821f8', '2a470fc0c3954d9dbb61de6d80846549', '分屏', '/jeecg/splitPanel', 'jeecg/SplitPanel', NULL, NULL, 1, NULL, NULL, 6, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-25 16:27:06', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('4148ec82b6acd69f470bea75fe41c357', '2a470fc0c3954d9dbb61de6d80846549', '单表模型示例', '/jeecg/jeecgDemoList', 'jeecg/JeecgDemoList', 'DemoList', NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, NULL, '2018-12-28 15:57:30', 'admin', '2019-02-15 16:24:37', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('418964ba087b90a84897b62474496b93', '540a2936940846cb98114ffb0d145cb8', '查询表格', '/list/query-list', 'list/TableList', NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('4356a1a67b564f0988a484f5531fd4d9', '2a470fc0c3954d9dbb61de6d80846549', '内嵌Table', '/jeecg/TableExpandeSub', 'jeecg/TableExpandeSub', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-04 22:48:13', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('45c966826eeff4c99b8f8ebfe74511fc', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '部门管理', '/isystem/depart', 'system/DepartList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-01-29 18:47:40', 'admin', '2019-12-25 09:36:47', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('4875ebe289344e14844d8e3ea1edd73f', '', '详情页', '/profile', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 8, 0, 'profile', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-04-02 11:46:48', 0, 0, NULL, NULL);
...
INSERT INTO "sys_permission" VALUES ('4f84f9400e5e92c95f05b554724c2b58', '540a2936940846cb98114ffb0d145cb8', '角色列表', '/list/role-list', 'list/RoleList', NULL, NULL, 1, NULL, NULL, 4, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('53a9230444d33de28aa11cc108fb1dba', '5c8042bd6c601270b2bbd9b20bccc68b', '我的消息', '/isps/userAnnouncement', 'system/UserAnnouncementList', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-04-19 10:16:00', 'admin', '2019-12-25 09:54:34', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('54097c6a3cf50fad0793a34beff1efdf', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO在线表单', '/online/cgformList/:code', 'modules/online/cgform/auto/OnlCgformAutoList', NULL, NULL, 1, NULL, NULL, 9, 0, NULL, 1, 1, NULL, 1, NULL, 'admin', '2019-03-19 16:03:06', 'admin', '2019-04-30 18:19:03', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('540a2936940846cb98114ffb0d145cb8', '', '列表页', '/list', 'layouts/PageView', NULL, '/list/query-list', 0, NULL, NULL, 9, 0, 'table', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-31 22:20:20', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('54dd5457a3190740005c1bfec55b1c34', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '菜单管理', '/isystem/permission', 'system/PermissionList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, 0, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-12-25 09:36:39', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('58857ff846e61794c69208e9d3a85466', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '日志管理', '/isystem/log', 'system/LogList', NULL, NULL, 1, NULL, NULL, 1, 0, '', 1, 1, NULL, 0, NULL, NULL, '2018-12-26 10:11:18', 'admin', '2019-04-02 11:38:17', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('58b9204feaf07e47284ddb36cd2d8468', '2a470fc0c3954d9dbb61de6d80846549', '图片翻页', '/jeecg/imgTurnPage', 'jeecg/ImgTurnPage', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-25 11:36:42', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('5c2f42277948043026b7a14692456828', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '我的部门', '/isystem/departUserList', 'system/DepartUserList', NULL, NULL, 1, NULL, NULL, 2, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-04-17 15:12:24', 'admin', '2019-12-25 09:35:26', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('5c8042bd6c601270b2bbd9b20bccc68b', '', '消息中心', '/message', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 6, 0, 'message', 1, 0, NULL, 0, NULL, 'admin', '2019-04-09 11:05:04', 'admin', '2019-04-11 19:47:54', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('6531cf3421b1265aeeeabaab5e176e6d', 'e3c13679c73a4f829bcff2aba8fd68b1', '分步表单', '/form/step-form', 'form/stepForm/StepForm', NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('655563cd64b75dcf52ef7bcdd4836953', '2a470fc0c3954d9dbb61de6d80846549', '图片预览', '/jeecg/ImagPreview', 'jeecg/ImagPreview', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-17 11:18:45', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('65a8f489f25a345836b7f44b1181197a', 'c65321e57b7949b7a975313220de0422', '403', '/exception/403', 'exception/403', NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('6ad53fd1b220989a8b71ff482d683a5a', '2a470fc0c3954d9dbb61de6d80846549', '一对多Tab示例', '/jeecg/tablist/JeecgOrderDMainList', 'jeecg/tablist/JeecgOrderDMainList', NULL, NULL, 1, NULL, NULL, 2, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-20 14:45:09', 'admin', '2019-02-21 16:26:21', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('6e73eb3c26099c191bf03852ee1310a1', '717f6bee46f44a3897eca9abd6e2ec44', '个人设置', '/account/settings/base', 'account/settings/Index', NULL, NULL, 1, NULL, NULL, 2, 1, NULL, 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-04-19 09:41:05', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('700b7f95165c46cc7a78bf227aa8fed3', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '性能监控', '/monitor', 'layouts/RouteView', NULL, NULL, 1, NULL, NULL, 0, 0, NULL, 1, 0, NULL, 0, NULL, 'admin', '2019-04-02 11:34:34', 'admin', '2019-05-05 17:49:47', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('717f6bee46f44a3897eca9abd6e2ec44', '', '个人页', '/account', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 9, 0, 'user', 1, 0, 0, 1, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2020-02-23 22:41:37', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('73678f9daa45ed17a3674131b03432fb', '540a2936940846cb98114ffb0d145cb8', '权限列表', '/list/permission-list', 'list/PermissionList', NULL, NULL, 1, NULL, NULL, 5, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('7593c9e3523a17bca83b8d7fe8a34e58', '3f915b2769fc80648e92d04e84ca059d', '添加用户按钮', '', NULL, NULL, NULL, 2, 'user:add', '1', 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-03-16 11:20:33', 'admin', '2019-05-17 18:31:25', 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('7960961b0063228937da5fa8dd73d371', '2a470fc0c3954d9dbb61de6d80846549', 'JEditableTable示例', '/jeecg/JEditableTable', 'jeecg/JeecgEditableTableExample', NULL, NULL, 1, NULL, NULL, 2, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-03-22 15:22:18', 'admin', '2019-12-25 09:48:16', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('7ac9eb9ccbde2f7a033cd4944272bf1e', '540a2936940846cb98114ffb0d145cb8', '卡片列表', '/list/card', 'list/CardList', NULL, NULL, 1, NULL, NULL, 7, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('841057b8a1bef8f6b4b20f9a618a7fa6', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '数据日志', '/sys/dataLog-list', 'system/DataLogList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-03-11 19:26:49', 'admin', '2019-03-12 11:40:47', 0, 0, NULL, NULL);
...
INSERT INTO "sys_permission" VALUES ('8b3bff2eee6f1939147f5c68292a1642', '700b7f95165c46cc7a78bf227aa8fed3', '服务器信息', '/monitor/SystemInfo', 'modules/monitor/SystemInfo', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-02 11:39:19', 'admin', '2019-04-02 15:40:02', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('8d1ebd663688965f1fd86a2f0ead3416', '700b7f95165c46cc7a78bf227aa8fed3', 'Redis监控', '/monitor/redis/info', 'modules/monitor/RedisInfo', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-02 13:11:33', 'admin', '2019-05-07 15:18:54', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('8d4683aacaa997ab86b966b464360338', 'e41b69c57a941a3bbcce45032fe57605', 'Online表单开发', '/online/cgform', 'modules/online/cgform/OnlCgformHeadList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 0, NULL, 0, NULL, 'admin', '2019-03-12 15:48:14', 'admin', '2019-06-11 14:19:17', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('8fb8172747a78756c11916216b8b8066', '717f6bee46f44a3897eca9abd6e2ec44', '工作台', '/dashboard/workplace', 'dashboard/Workplace', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-04-02 11:45:02', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('944abf0a8fc22fe1f1154a389a574154', '5c8042bd6c601270b2bbd9b20bccc68b', '消息管理', '/modules/message/sysMessageList', 'modules/message/SysMessageList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-09 11:27:53', 'admin', '2019-04-09 19:31:23', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('9502685863ab87f0ad1134142788a385', '', '首页', '/dashboard/analysis', 'dashboard/Analysis', NULL, NULL, 0, NULL, NULL, 0, 0, 'home', 1, 1, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-29 11:04:13', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('97c8629abc7848eccdb6d77c24bb3ebb', '700b7f95165c46cc7a78bf227aa8fed3', '磁盘监控', '/monitor/Disk', 'modules/monitor/DiskMonitoring', NULL, NULL, 1, NULL, NULL, 6, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-25 14:30:06', 'admin', '2019-05-05 14:37:14', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('9a90363f216a6a08f32eecb3f0bf12a3', '2a470fc0c3954d9dbb61de6d80846549', '自定义组件', '/jeecg/SelectDemo', 'jeecg/SelectDemo', NULL, NULL, 1, NULL, NULL, 0, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-03-19 11:19:05', 'admin', '2019-12-25 09:47:04', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('9cb91b8851db0cf7b19d7ecc2a8193dd', '1939e035e803a99ceecb6f5563570fb2', '我的任务表单', '/modules/bpm/task/form/FormModule', 'modules/bpm/task/form/FormModule', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-03-08 16:49:05', 'admin', '2019-03-08 18:37:56', 0, 0, NULL, NULL);
...
INSERT INTO "sys_permission" VALUES ('a400e4f4d54f79bf5ce160ae432231af', '2a470fc0c3954d9dbb61de6d80846549', '百度', 'http://www.baidu.com', 'layouts/IframePageView', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-01-29 19:44:06', 'admin', '2019-02-15 16:25:02', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('ae4fed059f67086fd52a73d913cf473d', '540a2936940846cb98114ffb0d145cb8', '内联编辑表格', '/list/edit-table', 'list/TableInnerEditList', NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('aedbf679b5773c1f25e9f7b10111da73', '08e6b9dc3c04489c8e1ff2ce6f105aa4', 'SQL监控', '{{ window._CONFIG[''domianURL''] }}/druid/', 'layouts/IframePageView', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-01-30 09:43:22', 'admin', '2019-03-23 19:00:46', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('b1cb0a3fedf7ed0e4653cb5a229837ee', '08e6b9dc3c04489c8e1ff2ce6f105aa4', '定时任务', '/isystem/QuartzJobList', 'system/QuartzJobList', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, NULL, '2019-01-03 09:38:52', 'admin', '2019-04-02 10:24:13', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('b3c824fc22bd953e2eb16ae6914ac8f9', '4875ebe289344e14844d8e3ea1edd73f', '高级详情页', '/profile/advanced', 'profile/advanced/Advanced', NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('b4dfc7d5dd9e8d5b6dd6d4579b1aa559', 'c65321e57b7949b7a975313220de0422', '500', '/exception/500', 'exception/500', NULL, NULL, 1, NULL, NULL, 3, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('b6bcee2ccc854052d3cc3e9c96d90197', '71102b3b87fb07e5527bbd2c530dd90a', '加班申请', '/modules/extbpm/joa/JoaOvertimeList', 'modules/extbpm/joa/JoaOvertimeList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-03 15:33:10', 'admin', '2019-04-03 15:34:48', 0, 0, NULL, NULL);
...
INSERT INTO "sys_permission" VALUES ('c65321e57b7949b7a975313220de0422', NULL, '异常页', '/exception', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 8, NULL, 'warning', 1, 0, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('c6cf95444d80435eb37b2f9db3971ae6', '2a470fc0c3954d9dbb61de6d80846549', '数据回执模拟', '/jeecg/InterfaceTest', 'jeecg/InterfaceTest', NULL, NULL, 1, NULL, NULL, 6, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-19 16:02:23', 'admin', '2019-02-21 16:25:45', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('cc50656cf9ca528e6f2150eba4714ad2', '4875ebe289344e14844d8e3ea1edd73f', '基础详情页', '/profile/basic', 'profile/basic/Index', NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('d07a2c87a451434c99ab06296727ec4f', '700b7f95165c46cc7a78bf227aa8fed3', 'JVM信息', '/monitor/JvmInfo', 'modules/monitor/JvmInfo', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-01 23:07:48', 'admin', '2019-04-02 11:37:16', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('d2bbf9ebca5a8fa2e227af97d2da7548', 'c65321e57b7949b7a975313220de0422', '404', '/exception/404', 'exception/404', NULL, NULL, 1, NULL, NULL, 2, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('d7d6e2e4e2934f2c9385a623fd98c6f3', '', '系统管理', '/isystem', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 4, 0, 'setting', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-31 22:19:52', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('d86f58e7ab516d3bc6bfb1fe10585f97', '717f6bee46f44a3897eca9abd6e2ec44', '个人中心', '/account/center', 'account/center/Index', NULL, NULL, 1, NULL, NULL, 1, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('de13e0f6328c069748de7399fcc1dbbd', 'fb07ca05a3e13674dbf6d3245956da2e', '搜索列表（项目）', '/list/search/project', 'list/TableList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-12 14:01:40', 'admin', '2019-02-12 14:14:18', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e08cb190ef230d5d4f03824198773950', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '系统通告', '/isystem/annountCement', 'system/SysAnnouncementList', NULL, NULL, 1, 'annountCement', NULL, 6, NULL, '', 1, 1, NULL, NULL, NULL, NULL, '2019-01-02 17:23:01', NULL, '2019-01-02 17:31:23', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e1979bb53e9ea51cecc74d86fd9d2f64', '2a470fc0c3954d9dbb61de6d80846549', 'PDF预览', '/jeecg/jeecgPdfView', 'jeecg/JeecgPdfView', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-25 10:39:35', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e3c13679c73a4f829bcff2aba8fd68b1', '', '表单页', '/form', 'layouts/PageView', NULL, NULL, 0, NULL, NULL, 9, 0, 'form', 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-03-31 22:20:14', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e41b69c57a941a3bbcce45032fe57605', '', '在线开发', '/online', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 5, 0, 'cloud', 1, 0, NULL, 0, NULL, 'admin', '2019-03-08 10:43:10', 'admin', '2019-05-11 10:36:01', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e5973686ed495c379d829ea8b2881fc6', 'e3c13679c73a4f829bcff2aba8fd68b1', '高级表单', '/form/advanced-form', 'form/advancedForm/AdvancedForm', NULL, NULL, 1, NULL, NULL, 3, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('e6bfd1fcabfd7942fdd05f076d1dad38', '2a470fc0c3954d9dbb61de6d80846549', '打印测试', '/jeecg/PrintDemo', 'jeecg/PrintDemo', NULL, NULL, 1, NULL, NULL, 3, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-19 15:58:48', 'admin', '2019-05-07 20:14:39', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('ebb9d82ea16ad864071158e0c449d186', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '分类字典', '/isys/category', 'system/SysCategoryList', NULL, NULL, 1, NULL, '1', 5, 0, NULL, 1, 1, 0, 0, NULL, 'admin', '2019-05-29 18:48:07', 'admin', '2020-02-23 22:45:33', 0, 0, '1', 0);
...
INSERT INTO "sys_permission" VALUES ('f0675b52d89100ee88472b6800754a08', '', '统计报表', '/report', 'layouts/RouteView', NULL, NULL, 0, NULL, NULL, 1, 0, 'bar-chart', 1, 0, NULL, 0, NULL, 'admin', '2019-04-03 18:32:02', 'admin', '2019-05-19 18:34:13', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('f1cb187abf927c88b89470d08615f5ac', 'd7d6e2e4e2934f2c9385a623fd98c6f3', '数据字典', '/isystem/dict', 'system/DictList', NULL, NULL, 1, NULL, NULL, 5, 0, NULL, 1, 1, 0, 0, NULL, NULL, '2018-12-28 13:54:43', 'admin', '2020-02-23 22:45:25', 0, 0, NULL, 0);
INSERT INTO "sys_permission" VALUES ('f23d9bfff4d9aa6b68569ba2cff38415', '540a2936940846cb98114ffb0d145cb8', '标准列表', '/list/basic-list', 'list/StandardList', NULL, NULL, 1, NULL, NULL, 6, NULL, NULL, 1, 1, NULL, NULL, NULL, NULL, '2018-12-25 20:34:38', NULL, NULL, 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('f2849d3814fc97993bfc519ae6bbf049', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO复制表单', '/online/copyform/:code', 'modules/online/cgform/OnlCgformCopyList', NULL, NULL, 1, NULL, '1', 1, 0, NULL, 1, 1, 0, 1, NULL, 'admin', '2019-08-29 16:05:37', NULL, NULL, 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('f780d0d3083d849ccbdb1b1baee4911d', '5c8042bd6c601270b2bbd9b20bccc68b', '模板管理', '/modules/message/sysMessageTemplateList', 'modules/message/SysMessageTemplateList', NULL, NULL, 1, NULL, NULL, 1, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-09 11:50:31', 'admin', '2019-04-12 10:16:34', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('fb07ca05a3e13674dbf6d3245956da2e', '540a2936940846cb98114ffb0d145cb8', '搜索列表', '/list/search', 'list/search/SearchLayout', NULL, '/list/search/article', 1, NULL, NULL, 8, 0, NULL, 1, 0, NULL, 0, NULL, NULL, '2018-12-25 20:34:38', 'admin', '2019-02-12 15:09:13', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('fb367426764077dcf94640c843733985', '2a470fc0c3954d9dbb61de6d80846549', '一对多示例', '/jeecg/JeecgOrderMainList', 'jeecg/JeecgOrderMainList', NULL, NULL, 1, NULL, NULL, 2, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-02-15 16:24:11', 'admin', '2019-02-18 10:50:14', 0, 0, NULL, NULL);
INSERT INTO "sys_permission" VALUES ('fba41089766888023411a978d13c0aa4', 'e41b69c57a941a3bbcce45032fe57605', 'AUTO树表单列表', '/online/cgformTreeList/:code', 'modules/online/cgform/auto/OnlCgformTreeList', NULL, NULL, 1, NULL, '1', 9, 0, NULL, 1, 1, NULL, 1, NULL, 'admin', '2019-05-21 14:46:50', 'admin', '2019-06-11 13:52:52', 0, 0, '1', NULL);
INSERT INTO "sys_permission" VALUES ('fc810a2267dd183e4ef7c71cc60f4670', '700b7f95165c46cc7a78bf227aa8fed3', '请求追踪', '/monitor/HttpTrace', 'modules/monitor/HttpTrace', NULL, NULL, 1, NULL, NULL, 4, 0, NULL, 1, 1, NULL, 0, NULL, 'admin', '2019-04-02 09:46:19', 'admin', '2019-04-02 11:37:27', 0, 0, NULL, NULL);
...
CREATE TABLE "sys_position" (
  ...
  "name" varchar(100) COLLATE "pg_catalog"."default",
  "rank" varchar(2) COLLATE "pg_catalog"."default",
...
COMMENT ON COLUMN "sys_position"."rank" IS '职级';
...
CREATE TABLE "sys_user" (
  ...
  "org_code" varchar(2000) COLLATE "pg_catalog"."default",
  "status" int4,
  "del_flag" int4,
  "activiti_sync" int4,
...
COMMENT ON COLUMN "sys_user"."identity" IS '身份（1普通成员 2上级）';
...
CREATE TABLE "test_person" (
  ...
  "update_by" varchar(50) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "update_time" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "sex" varchar(32) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "name" varchar(200) COLLATE "pg_catalog"."default" DEFAULT NULL::character varying,
  "content" text COLLATE "pg_catalog"."default",
  "be_date" timestamp(0) DEFAULT NULL::timestamp without time zone,
  "qj_days" int2
)
;
COMMENT ON COLUMN "test_person"."id" IS '主键';
...
-- ----------------------------
ALTER TABLE "jeecg_monthly_growth_analysis" ADD CONSTRAINT "jeecg_monthly_growth_analysis_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table jeecg_order_customer
-- ----------------------------
ALTER TABLE "jeecg_order_customer" ADD CONSTRAINT "jeecg_order_customer_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table jeecg_order_main
-- ----------------------------
ALTER TABLE "jeecg_order_main" ADD CONSTRAINT "jeecg_order_main_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table jeecg_order_ticket
-- ----------------------------
ALTER TABLE "jeecg_order_ticket" ADD CONSTRAINT "jeecg_order_ticket_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table jeecg_project_nature_income
-- ----------------------------
ALTER TABLE "jeecg_project_nature_income" ADD CONSTRAINT "jeecg_project_nature_income_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_button
-- ----------------------------
CREATE INDEX "index_button_code" ON "onl_cgform_button" USING btree (
  "button_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_button_order" ON "onl_cgform_button" USING btree (
  "order_num" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_button_status" ON "onl_cgform_button" USING btree (
  "button_status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_formid" ON "onl_cgform_button" USING btree (
...
-- ----------------------------
ALTER TABLE "onl_cgform_button" ADD CONSTRAINT "onl_cgform_button_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_enhance_java
-- ----------------------------
CREATE INDEX "index_buttoncode" ON "onl_cgform_enhance_java" USING btree (
  "button_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_fmid" ON "onl_cgform_enhance_java" USING btree (
  "cgform_head_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_status" ON "onl_cgform_enhance_java" USING btree (
...
-- ----------------------------
ALTER TABLE "onl_cgform_enhance_java" ADD CONSTRAINT "onl_cgform_enhance_java_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_enhance_js
-- ----------------------------
CREATE INDEX "index_fmhid" ON "onl_cgform_enhance_js" USING btree (
  "cgform_head_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_jstype" ON "onl_cgform_enhance_js" USING btree (
  "cg_js_type" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table onl_cgform_enhance_js
-- ----------------------------
ALTER TABLE "onl_cgform_enhance_js" ADD CONSTRAINT "onl_cgform_enhance_js_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_enhance_sql
-- ----------------------------
CREATE INDEX "index_form_head_id" ON "onl_cgform_enhance_sql" USING btree (
  "cgform_head_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "onl_cgform_enhance_sql" ADD CONSTRAINT "onl_cgform_enhance_sql_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_field
-- ----------------------------
CREATE INDEX "inex_table_id" ON "onl_cgform_field" USING btree (
  "cgform_head_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "onl_cgform_field" ADD CONSTRAINT "onl_cgform_field_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_head
-- ----------------------------
CREATE INDEX "index_form_templdate" ON "onl_cgform_head" USING btree (
  "form_template" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "index_onlineform_table_name" ON "onl_cgform_head" USING btree (
  "table_name" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_onlineform_table_version" ON "onl_cgform_head" USING btree (
  "table_version" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_templdate_mobile" ON "onl_cgform_head" USING btree (
  "form_template_mobile" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table onl_cgform_head
-- ----------------------------
ALTER TABLE "onl_cgform_head" ADD CONSTRAINT "onl_cgform_head_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgform_index
-- ----------------------------
CREATE INDEX "index_table_id" ON "onl_cgform_index" USING btree (
  "cgform_head_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "onl_cgform_index" ADD CONSTRAINT "onl_cgform_index_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgreport_head
-- ----------------------------
CREATE UNIQUE INDEX "index_onlinereport_code" ON "onl_cgreport_head" USING btree (
...
-- ----------------------------
ALTER TABLE "onl_cgreport_head" ADD CONSTRAINT "onl_cgreport_head_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgreport_item
-- ----------------------------
CREATE INDEX "index_cgrhead_id" ON "onl_cgreport_item" USING btree (
  "cgrhead_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_isshow" ON "onl_cgreport_item" USING btree (
  "is_show" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_order_num" ON "onl_cgreport_item" USING btree (
  "order_num" "pg_catalog"."int8_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "onl_cgreport_item" ADD CONSTRAINT "onl_cgreport_item_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table onl_cgreport_param
-- ----------------------------
CREATE INDEX "idx_cgrheadid" ON "onl_cgreport_param" USING btree (
  "cgrhead_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "onl_cgreport_param" ADD CONSTRAINT "onl_cgreport_param_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table oss_file
-- ----------------------------
ALTER TABLE "oss_file" ADD CONSTRAINT "oss_file_pkey" PRIMARY KEY ("id");
...
-- ----------------------------
CREATE INDEX "sched_name_idx" ON "qrtz_triggers" USING btree (
...
-- ----------------------------
ALTER TABLE "sys_announcement" ADD CONSTRAINT "sys_announcement_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_category
-- ----------------------------
ALTER TABLE "sys_category" ADD CONSTRAINT "sys_category_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_check_rule
-- ----------------------------
CREATE UNIQUE INDEX "uni_sys_check_rule_code" ON "sys_check_rule" USING btree (
...
-- ----------------------------
ALTER TABLE "sys_check_rule" ADD CONSTRAINT "sys_check_rule_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_data_log
-- ----------------------------
CREATE INDEX "sindex" ON "sys_data_log" USING btree (
  "data_table" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
...
-- ----------------------------
ALTER TABLE "sys_data_log" ADD CONSTRAINT "sys_data_log_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_data_source
-- ----------------------------
CREATE UNIQUE INDEX "sys_data_source_code_uni" ON "sys_data_source" USING btree (
  "code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_data_source" ADD CONSTRAINT "sys_data_source_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_depart
-- ----------------------------
CREATE INDEX "index_depart_parent_id" ON "sys_depart" USING btree (
...
-- ----------------------------
ALTER TABLE "sys_depart" ADD CONSTRAINT "sys_depart_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_depart_permission
-- ----------------------------
ALTER TABLE "sys_depart_permission" ADD CONSTRAINT "sys_depart_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_depart_role
-- ----------------------------
ALTER TABLE "sys_depart_role" ADD CONSTRAINT "sys_depart_role_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_depart_role_permission
-- ----------------------------
CREATE INDEX "index_group_per_id" ON "sys_depart_role_permission" USING btree (
  "permission_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_group_role_id" ON "sys_depart_role_permission" USING btree (
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_group_role_per_id" ON "sys_depart_role_permission" USING btree (
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "permission_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_depart_role_permission" ADD CONSTRAINT "sys_depart_role_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_depart_role_user
-- ----------------------------
ALTER TABLE "sys_depart_role_user" ADD CONSTRAINT "sys_depart_role_user_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_dict
-- ----------------------------
CREATE UNIQUE INDEX "indextable_dict_code" ON "sys_dict" USING btree (
...
-- ----------------------------
CREATE INDEX "index_table_dict_id" ON "sys_dict_item" USING btree (
  "dict_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_table_dict_status" ON "sys_dict_item" USING btree (
  "status" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_table_sort_order" ON "sys_dict_item" USING btree (
  "sort_order" "pg_catalog"."int8_ops" ASC NULLS LAST
);
...
-- ----------------------------
CREATE UNIQUE INDEX "uni_sys_fill_rule_code" ON "sys_fill_rule" USING btree (
  "rule_code" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_fill_rule" ADD CONSTRAINT "sys_fill_rule_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_log
-- ----------------------------
CREATE INDEX "index_log_type" ON "sys_log" USING btree (
  "log_type" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_operate_type" ON "sys_log" USING btree (
  "operate_type" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_table_userid" ON "sys_log" USING btree (
...
-- ----------------------------
CREATE INDEX "index_menu_hidden" ON "sys_permission" USING btree (
  "hidden" "pg_catalog"."int2_ops" ASC NULLS LAST
);
CREATE INDEX "index_menu_status" ON "sys_permission" USING btree (
  "status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_menu_type" ON "sys_permission" USING btree (
  "menu_type" "pg_catalog"."int8_ops" ASC NULLS LAST
);
CREATE INDEX "index_prem_del_flag" ON "sys_permission" USING btree (
  "del_flag" "pg_catalog"."int2_ops" ASC NULLS LAST
);
CREATE INDEX "index_prem_is_leaf" ON "sys_permission" USING btree (
  "is_leaf" "pg_catalog"."int2_ops" ASC NULLS LAST
);
CREATE INDEX "index_prem_is_route" ON "sys_permission" USING btree (
  "is_route" "pg_catalog"."int2_ops" ASC NULLS LAST
);
CREATE INDEX "index_prem_pid" ON "sys_permission" USING btree (
  "parent_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_prem_sort_no" ON "sys_permission" USING btree (
  "sort_no" "pg_catalog"."int4_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table sys_permission
-- ----------------------------
ALTER TABLE "sys_permission" ADD CONSTRAINT "sys_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_permission_data_rule
-- ----------------------------
CREATE INDEX "index_fucntionid" ON "sys_permission_data_rule" USING btree (
  "permission_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_permission_data_rule" ADD CONSTRAINT "sys_permission_data_rule_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_position
-- ----------------------------
ALTER TABLE "sys_position" ADD CONSTRAINT "sys_position_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table sys_quartz_job
-- ----------------------------
ALTER TABLE "sys_quartz_job" ADD CONSTRAINT "sys_quartz_job_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_role
-- ----------------------------
CREATE UNIQUE INDEX "uniq_sys_role_role_code" ON "sys_role" USING btree (
...
-- ----------------------------
CREATE INDEX "index_permission_id" ON "sys_role_permission" USING btree (
  "permission_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_role_id" ON "sys_role_permission" USING btree (
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_role_permission_id" ON "sys_role_permission" USING btree (
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "permission_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_role_permission" ADD CONSTRAINT "sys_role_permission_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_sms
-- ----------------------------
CREATE INDEX "index_es_send_status" ON "sys_sms" USING btree (
  "es_send_status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_receiver" ON "sys_sms" USING btree (
  "es_receiver" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_sendtime" ON "sys_sms" USING btree (
  "es_send_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST
);
CREATE INDEX "index_type" ON "sys_sms" USING btree (
  "es_type" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);

-- ----------------------------
-- Primary Key structure for table sys_sms
-- ----------------------------
ALTER TABLE "sys_sms" ADD CONSTRAINT "sys_sms_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_sms_template
-- ----------------------------
CREATE UNIQUE INDEX "uniq_templatecode" ON "sys_sms_template" USING btree (
...
-- ----------------------------
ALTER TABLE "sys_sms_template" ADD CONSTRAINT "sys_sms_template_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_user
-- ----------------------------
CREATE INDEX "index_user_del_flag" ON "sys_user" USING btree (
  "del_flag" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "index_user_name" ON "sys_user" USING btree (
  "username" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_user_status" ON "sys_user" USING btree (
  "status" "pg_catalog"."int4_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "uniq_sys_user_work_no" ON "sys_user" USING btree (
  "work_no" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
CREATE INDEX "begintime_index" ON "sys_user_agent" USING btree (
  "start_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST
);
CREATE INDEX "endtime_index" ON "sys_user_agent" USING btree (
  "end_time" "pg_catalog"."timestamp_ops" ASC NULLS LAST
);
CREATE INDEX "statux_index" ON "sys_user_agent" USING btree (
  "status" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE UNIQUE INDEX "uniq_username" ON "sys_user_agent" USING btree (
...
-- ----------------------------
ALTER TABLE "sys_user_agent" ADD CONSTRAINT "sys_user_agent_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_user_depart
-- ----------------------------
CREATE INDEX "index_depart_groupk_uidanddid" ON "sys_user_depart" USING btree (
  "user_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "dep_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_depart_groupk_userid" ON "sys_user_depart" USING btree (
  "user_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index_depart_groupkorgid" ON "sys_user_depart" USING btree (
  "dep_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "sys_user_depart" ADD CONSTRAINT "sys_user_depart_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes structure for table sys_user_role
-- ----------------------------
CREATE INDEX "index2_groupuu_ole_id" ON "sys_user_role" USING btree (
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index2_groupuu_user_id" ON "sys_user_role" USING btree (
  "user_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
CREATE INDEX "index2_groupuu_useridandroleid" ON "sys_user_role" USING btree (
  "user_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST,
  "role_id" COLLATE "pg_catalog"."default" "pg_catalog"."text_ops" ASC NULLS LAST
);
...
-- ----------------------------
ALTER TABLE "test_demo" ADD CONSTRAINT "test_demo_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table test_order_main
-- ----------------------------
ALTER TABLE "test_order_main" ADD CONSTRAINT "test_order_main_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table test_order_product
-- ----------------------------
ALTER TABLE "test_order_product" ADD CONSTRAINT "test_order_product_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Primary Key structure for table test_person
-- ----------------------------
ALTER TABLE "test_person" ADD CONSTRAINT "test_person_pkey" PRIMARY KEY ("id");
