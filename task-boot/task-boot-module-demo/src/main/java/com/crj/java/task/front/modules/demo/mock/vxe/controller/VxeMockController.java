package com.crj.java.task.front.modules.demo.mock.vxe.controller;
...
import com.crj.java.task.front.common.constant.VXESocketConst;
import com.crj.java.task.front.common.system.query.MatchTypeEnum;
import com.crj.java.task.front.common.system.query.QueryCondition;
import com.crj.java.task.front.common.system.query.QueryGenerator;
import com.crj.java.task.front.modules.demo.mock.vxe.entity.MockEntity;
import com.crj.java.task.front.modules.demo.mock.vxe.websocket.VXESocket;
...
public class VxeMockController {
    ...
    public Result getMockData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/task/modules/demo/mock/vxe/json/dlglong.json";
        // 读取JSON数据
    ...
    public Result getMockDdjhData(
        ...
        // 模拟JSON数据路径
        String path = "classpath:org/task/modules/demo/mock/vxe/json/ddjh.json";
        if ("8".equals(status)) {
            path = "classpath:org/task/modules/demo/mock/vxe/json/ddjh_s8.json";
        }
        // 读取JSON数据
        JSONArray dataList = readJsonData(path);
        if (dataList == null) {
