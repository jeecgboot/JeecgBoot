...
import com.crj.java.task.front.modules.demo.mock.MockController;
...
//	private ISysDataLogService sysDataLogService;
	...
	public void testSelect() {
		...
		List<TaskDemo> userList = taskDemoMapper.selectList(null);
	...
	public void testXmlSql() {
		System.out.println(("----- selectAll method test ------"));
		List<TaskDemo> userList = taskDemoMapper.getDemoByName("Sandy12");
		userList.forEach(System.out::println);
	}
