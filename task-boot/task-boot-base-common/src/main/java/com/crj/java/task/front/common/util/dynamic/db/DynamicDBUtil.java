package com.crj.java.task.front.common.util.dynamic.db;
...
import com.crj.java.task.front.common.exception.TaskBootException;
import com.crj.java.task.front.common.system.vo.DynamicDataSourceModel;
import com.crj.java.task.front.common.util.ReflectHelper;
    ...
    public static DruidDataSource getDbSourceByDbKey(final String dbKey) {
        ...
        if (cacheDbSource != null && !cacheDbSource.isClosed()) {
            ...
            if(dataSource!=null && dataSource.isEnable()){
                ...
                throw new TaskBootException("动态数据源连接失败，dbKey："+dbKey);
            }
