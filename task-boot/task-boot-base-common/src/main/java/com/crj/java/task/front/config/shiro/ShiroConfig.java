...
import com.crj.java.task.front.config.shiro.filters.JwtFilter;
...
public class ShiroConfig {
    ...
    public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/test/joaDemo/hello", "anon");
        ...
        //测试示例
        //filterChainDefinitionMap.put("/test/taskDemo/html", "anon"); //模板页面
        //filterChainDefinitionMap.put("/test/taskDemo/redis/**", "anon"); //redis测试
