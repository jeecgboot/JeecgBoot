package com.crj.java.task.front.common.util.jsonschema;
...
public class JsonschemaUtil {
	...
	public static JSONObject getJsonSchema(JsonSchemaDescrip descrip, List<CommonProperty> propertyList) {
		...
		//鬼知道这里为什么报错 com.crj.java.task.front.modules.system.model.DictModel cannot be cast to com.crj.java.task.front.modules.system.model.DictModel
