package com.crj.java.task.front.common.es;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import lombok.extern.slf4j.Slf4j;
import org.apache.commons.lang.StringUtils;
import com.crj.java.task.front.common.util.RestUtil;
...
@Slf4j
@Component
public class TaskElasticsearchTemplate {
    /** es服务地址 */
    ...
    public TaskElasticsearchTemplate(@Value("${task.elasticsearch.cluster-nodes}") String baseUrl, @Value("${task.elasticsearch.check-enabled}") boolean checkEnabled) {
        log.debug("TaskElasticsearchTemplate BaseURL：" + baseUrl);
