package com.crj.java.task.front.common.system.util;
...
public class JwtUtil {
	 ...
	 * @param request
	 * @return
	 * @throws TaskBootException
	 */
	public static String getUserNameByToken(HttpServletRequest request) throws TaskBootException {
		String accessToken = request.getHeader("X-Access-Token");
		String username = getUsername(accessToken);
		if (oConvertUtils.isEmpty(username)) {
			throw new TaskBootException("未获取到用户");
		}
		return username;
	}
	...
	public static String getUserSystemData(String key,SysUserCacheInfo user) {
		if(user==null) {
			user = TaskDataAutorUtils.loadUserInfo();
		}
		//#{sys_user_code}%
