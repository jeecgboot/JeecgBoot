...
public class PermissionDataAspect {
    ...
    @Pointcut("@annotation(com.crj.java.task.front.common.aspect.annotation.PermissionData)")
    ...
    public Object arround(ProceedingJoinPoint point) throws  Throwable{
        ...
        if(dataRules!=null && dataRules.size()>0) {
            //临时存储
            TaskDataAutorUtils.installDataSearchConditon(request, dataRules);
            //TODO 微服务情况下也得支持缓存机制
            SysUserCacheInfo userinfo = commonAPI.getCacheUser(username);
            TaskDataAutorUtils.installUserInfo(request, userinfo);
        }
