package com.crj.java.task.front.common.system.query;
...
import com.crj.java.task.front.common.system.util.TaskDataAutorUtils;
...
public class QueryGenerator {
	 ...
	 * <br>错误示例:如QueryWrapper<TaskDemo> queryWrapper = new QueryWrapper<TaskDemo>(taskDemo);
	 * <br>正确示例:QueryWrapper<TaskDemo> queryWrapper = new QueryWrapper<TaskDemo>();
	...
	private static QueryRuleEnum convert2Rule(Object value) {
		...
		//update-begin--Author:Crj  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284-------------------
		...
		//update-end--Author:Crj  Date:20190724 for：initQueryWrapper组装sql查询条件错误 #284---------------------
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap() {
		...
		List<SysPermissionDataRuleModel> list =TaskDataAutorUtils.loadDataSearchConditon();
	...
	public static Map<String, SysPermissionDataRuleModel> getRuleMap(List<SysPermissionDataRuleModel> list) {
		Map<String, SysPermissionDataRuleModel> ruleMap = new HashMap<String, SysPermissionDataRuleModel>();
		if(list==null){
			list =TaskDataAutorUtils.loadDataSearchConditon();
		}
		if(list != null&&list.size()>0){
			if(list.get(0)==null){
				return ruleMap;
