package com.crj.java.task.front.common.util;
...
//			com.crj.java.task.front.core.util.LogUtil.info(after_code);
//			com.crj.java.task.front.core.util.LogUtil.info(after_code_zimu);
//			com.crj.java.task.front.core.util.LogUtil.info(after_code_num);
...
//			return parentCode + getNextYouBianCode(localCode);
	...
	public static void main(String[] args) {
		// com.crj.java.task.front.core.util.LogUtil.info(getNextZiMu('C'));
		// com.crj.java.task.front.core.util.LogUtil.info(getNextNum(8));
	    // com.crj.java.task.front.core.util.LogUtil.info(cutYouBianCode("C99A01B01")[2]);
	}
}
