...
import com.crj.java.task.front.common.constant.FillRuleConstant;
import com.crj.java.task.front.common.exception.TaskBootException;
import com.crj.java.task.front.common.util.FillRuleUtil;
import com.crj.java.task.front.common.util.YouBianCodeUtil;
import com.crj.java.task.front.common.util.oConvertUtils;
import com.crj.java.task.front.modules.system.entity.SysCategory;
import com.crj.java.task.front.modules.system.mapper.SysCategoryMapper;
import com.crj.java.task.front.modules.system.model.TreeSelectModel;
import com.crj.java.task.front.modules.system.service.ISysCategoryService;
...
public class SysCategoryServiceImpl extends ServiceImpl<SysCategoryMapper, SysCategory> implements ISysCategoryService {
	...
	@Override
	public List<TreeSelectModel> queryListByCode(String pcode) throws TaskBootException{
		...
		if(oConvertUtils.isNotEmpty(pcode)) {
			...
			if(list==null || list.size() ==0) {
				throw new TaskBootException("该编码【"+pcode+"】不存在，请核实!");
			}
			if(list.size()>1) {
				throw new TaskBootException("该编码【"+pcode+"】存在多个，请核实!");
			}
