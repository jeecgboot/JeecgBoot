package com.crj.java.task.front.modules.ngalain.service.impl;

import com.alibaba.fastjson.JSONArray;
import com.alibaba.fastjson.JSONObject;
import com.crj.java.task.front.common.util.MD5Util;
import com.crj.java.task.front.common.util.oConvertUtils;
import com.crj.java.task.front.modules.ngalain.mapper.NgAlainMapper;
import com.crj.java.task.front.modules.ngalain.service.NgAlainService;
import com.crj.java.task.front.modules.system.entity.SysPermission;
import com.crj.java.task.front.modules.system.service.ISysPermissionService;
...
public class NgAlainServiceImpl implements NgAlainService {
    ...
    public JSONArray getMenu(String id) throws Exception {
        return getTaskMenu(id);
    }
    @Override
    public JSONArray getTaskMenu(String id) throws Exception {
        ...
        JSONObject taskMenu = new JSONObject();
        taskMenu.put("text", "task菜单");
        taskMenu.put("group",true);
        taskMenu.put("children", menulist);
        JSONArray taskMenuList=new JSONArray();
