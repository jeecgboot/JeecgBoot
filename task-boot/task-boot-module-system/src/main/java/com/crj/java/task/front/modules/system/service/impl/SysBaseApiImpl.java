...
import com.crj.java.task.front.common.api.dto.message.*;
import com.crj.java.task.front.common.api.dto.OnlineAuthDTO;
import com.crj.java.task.front.common.aspect.UrlMatchEnum;
...
import com.crj.java.task.front.common.constant.DataBaseConstant;
import com.crj.java.task.front.common.constant.WebsocketConst;
import com.crj.java.task.front.common.exception.TaskBootException;
...
import com.crj.java.task.front.common.system.vo.*;
import com.crj.java.task.front.common.util.SysAnnmentTypeEnum;
import com.crj.java.task.front.common.util.YouBianCodeUtil;
...
import com.crj.java.task.front.modules.message.websocket.WebSocket;
import com.crj.java.task.front.modules.system.entity.*;
import com.crj.java.task.front.modules.system.mapper.*;
import com.crj.java.task.front.modules.system.service.*;
...
public class SysBaseApiImpl implements ISysBaseAPI {
	...
	public List<SysPermissionDataRuleModel> queryPermissionDataRule(String component, String requestPath, String username) {
		...
		if(currentSyspermission!=null && currentSyspermission.size()>0){
			...
			for (SysPermission sysPermission : currentSyspermission) {
				// update-begin--Author:Crj Date:20191119 for：数据权限规则编码不规范，项目存在相同包名和类名 #722
				...
				// update-end--Author:Crj Date:20191119 for：数据权限规则编码不规范，项目存在相同包名和类名 #722
			}
			return dataRules;
		}
		return null;
	...
	public void sendTemplateAnnouncement(TemplateMessageDTO message) {
		...
		if(sysSmsTemplates==null||sysSmsTemplates.size()==0){
			throw new TaskBootException("消息模板不存在，模板编码："+templateCode);
		}
		...
		if("".equals(DB_TYPE)) {
			...
			try {
				...
				if(dbType.indexOf("mysql")>=0) {
					...
					throw new TaskBootException("数据库类型:["+dbType+"]不识别!");
				}
			} catch (Exception e) {
