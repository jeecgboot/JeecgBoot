package com.crj.java.task.front.modules.quartz.service.impl;
...
import com.crj.java.task.front.modules.quartz.mapper.QuartzJobMapper;
import com.crj.java.task.front.modules.quartz.service.IQuartzJobService;
import org.quartz.*;
...
public class QuartzJobServiceImpl extends ServiceImpl<QuartzJobMapper, QuartzJob> implements IQuartzJobService {
	...
	private void schedulerAdd(String jobClassName, String cronExpression, String parameter) {
		try {
			...
			throw new TaskBootException("创建定时任务失败", e);
		} catch (RuntimeException e) {
			throw new TaskBootException(e.getMessage(), e);
		}catch (Exception e) {
			throw new TaskBootException("后台找不到该类名：" + jobClassName, e);
		}
	}
	...
	private void schedulerDelete(String jobClassName) {
		try {
			...
			throw new TaskBootException("删除定时任务失败");
		}
	}
