package com.crj.java.task.front.modules.message.job;

import java.util.List;

import com.crj.java.task.front.common.util.DateUtils;
import com.crj.java.task.front.modules.message.entity.SysMessage;
import com.crj.java.task.front.modules.message.handle.ISendMsgHandle;
import com.crj.java.task.front.modules.message.handle.enums.SendMsgStatusEnum;
import com.crj.java.task.front.modules.message.handle.enums.SendMsgTypeEnum;
...
public class SendMsgJob implements Job {
	...
	public void execute(JobExecutionContext jobExecutionContext) throws JobExecutionException {
		...
		log.info(String.format(" Task-Boot 发送消息任务 SendMsgJob !  时间:" + DateUtils.getTimestamp()));
