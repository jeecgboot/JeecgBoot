...
public class JeecgController<T, S extends IService<T>> {
	...
	protected ModelAndView exportXls(HttpServletRequest request, T object, Class<T> clazz, String title) {
		...
		// update-begin--Author:liusq Date:20210126
		// for：图片导出报错，ImageBasePath未设置--------------------
		ExportParams exportParams = new ExportParams(title + "报表", "导出人:" + sysUser.getRealname(), title);
		exportParams.setImageBasePath(upLoadPath);
		// update-end--Author:liusq Date:20210126
		// for：图片导出报错，ImageBasePath未设置----------------------
	 ...
	 * @param request
	 */
	protected ModelAndView exportXlsSheet(HttpServletRequest request, T object, Class<T> clazz, String title,
