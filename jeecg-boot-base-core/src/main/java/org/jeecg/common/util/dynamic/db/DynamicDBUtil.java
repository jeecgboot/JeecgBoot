...
public class DynamicDBUtil {
	...
	/**
	 * Executes the SQL statement in this <code>PreparedStatement</code> object, which
	 ...
	 * @return
	 */
	public static List<Map<String, Object>> findListByNamedParam(final String dbKey, String sql,
	 ...
	 * @return
	 */
	public static <T> List<T> findListEntitiesByHash(final String dbKey, String sql, Class<T> clazz,
			HashMap<String, Object> data) {
