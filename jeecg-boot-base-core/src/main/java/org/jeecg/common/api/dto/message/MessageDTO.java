...
public class MessageDTO implements Serializable {
	...
	// -----------------------------------------------------------------------
	// update-begin---author:taoyan ---date:20220705
	// for：支持自定义推送类型，邮件、钉钉、企业微信、系统消息-----------
	...
	/**
	 * 消息类型：org.jeecg.common.constant.enums.MessageTypeEnum XT("system", "系统消息")
	 * YJ("email", "邮件消息") DD("dingtalk", "钉钉消息") QYWX("wechat_enterprise", "企业微信")
	 */
	...
	// update-end---author:taoyan ---date::20220705
	// for：支持自定义推送类型，邮件、钉钉、企业微信、系统消息-----------
	// -----------------------------------------------------------------------
