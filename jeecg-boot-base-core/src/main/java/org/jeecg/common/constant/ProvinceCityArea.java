...
public class ProvinceCityArea {
	...
	public String getCode(String text) {
		...
		if (areaList != null && areaList.size() > 0) {
			for (int i = areaList.size() - 1; i >= 0; i--) {
				// update-begin-author:taoyan date:2022-5-24 for:VUEN-1088 online 导入
				// 省市区导入后 导入数据错乱 北京市/市辖区/西城区-->山西省/晋城市/城区
				...
				// update-end-author:taoyan date:2022-5-24 for:VUEN-1088 online 导入 省市区导入后
				// 导入数据错乱 北京市/市辖区/西城区-->山西省/晋城市/城区
			}
		}
		return null;
	}

	// update-begin-author:sunjianlei date:20220121 for:【JTC-704】数据导入错误
	// 省市区组件，文件中为北京市，导入后，导为了山西省
	/**
	 * 获取省市区code，精准匹配
	...
	// update-end-author:sunjianlei date:20220121 for:【JTC-704】数据导入错误
	// 省市区组件，文件中为北京市，导入后，导为了山西省
					...
					for (String cityKey : cityJson.keySet()) {
						...
						if (areaJson != null) {
							for (String areaKey : areaJson.keySet()) {
								...
								// update-begin-author:taoyan date:2022-5-24 for:VUEN-1088
								// online 导入 省市区导入后 导入数据错乱 北京市/市辖区/西城区-->山西省/晋城市/城区
								area.setAheadText(cityJson.getString(cityKey));
								// update-end-author:taoyan date:2022-5-24 for:VUEN-1088
								// online 导入 省市区导入后 导入数据错乱 北京市/市辖区/西城区-->山西省/晋城市/城区
