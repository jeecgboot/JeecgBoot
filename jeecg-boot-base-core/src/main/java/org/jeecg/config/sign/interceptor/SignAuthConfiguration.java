...
public class SignAuthConfiguration implements WebMvcConfigurer {
	...
	// update-begin-author:taoyan date:20220427 for: issues/I53J5E post请求X_SIGN签名拦截校验后报错,
	// request body 为空
	@Bean
	...
	// update-end-author:taoyan date:20220427 for: issues/I53J5E post请求X_SIGN签名拦截校验后报错,
	// request body 为空
