 ...
 * 1、导出的时候会根据字典配置，把值1,2翻译成：男、女; 2、导入的时候，会把男、女翻译成1,2存进数据库;
 *
 * @Author:scott @since：2019-04-09
 * @Version:1.0
 */
@Slf4j
@Service
public class AutoPoiDictConfig implements AutoPoiDictServiceI {
	...
	public String[] queryDict(String dicTable, String dicCode, String dicText) {
		...
		for (DictModel t : dictList) {
			if (t != null) {
				// update-begin---author:scott Date:20211220 for：[issues/I4MBB3]@Excel
				// dicText字段的值有下划线时，导入功能不能正确解析---
				...
				// update-end---author:20211220 Date:20211220 for：[issues/I4MBB3]@Excel
				// dicText字段的值有下划线时，导入功能不能正确解析---
			}
		}
