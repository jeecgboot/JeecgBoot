<template>
  <a-row class="j-select-biz-component-box" type="flex" :gutter="8">
    ...
    <j-multi-line-select-biz-component-modal
      v-model="selectValue"
...
<script>
  import JMultiLineSelectBizComponentModal from './JMultiLineSelectBizComponentModal'
  import ARow from "ant-design-vue/es/grid/Row";
  import ACol from "ant-design-vue/es/grid/Col";

  export default {
    name: 'JMultiLineSelectBizComponent',
    components: {ACol, ARow, JMultiLineSelectBizComponentModal },
    props: {
      value: {
        type: String,
        default: ''
