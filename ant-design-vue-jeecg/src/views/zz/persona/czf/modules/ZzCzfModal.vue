        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="建筑用途" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['jzyt', validatorRules.jzyt]" :trigger-change="true"
                                 dictCode="jzyt" placeholder="请选择建筑用途"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="出租用途" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['czyt', validatorRules.czyt]" :trigger-change="true"
                                 dictCode="czyt" placeholder="请选择出租用途"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="隐患类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['yhlx', validatorRules.yhlx]" :trigger-change="true"
                                 dictCode="yhlx" placeholder="请选择隐患类型"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
