        ...
        <a-row>
          ...
          <a-col :span="12">
            <a-form-item label="生日" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择生日" v-decorator="[ 'birthday', validatorRules.birthday]" :trigger-change="true"
                      style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="证件类型" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['zjlx', validatorRules.zjlx]" :trigger-change="true"
                                 dictCode="zjlx" placeholder="请选择证件类型"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="证件有效期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择证件有效期" v-decorator="[ 'zjyxq', validatorRules.zjyxq]" :trigger-change="true"
                      style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
          ...
          <a-col :span="12">
            <a-form-item label="抵达日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择抵达日期" v-decorator="[ 'ddDate', validatorRules.ddDate]" :trigger-change="true"
                      style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="预计离开日期" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-date placeholder="请选择预计离开日期" v-decorator="[ 'yjlkDate', validatorRules.yjlkDate]"
                      :trigger-change="true" style="width: 100%"/>
            </a-form-item>
          </a-col>
          <a-col :span="12">
            <a-form-item label="是否重点关注" :labelCol="labelCol" :wrapperCol="wrapperCol">
              <j-dict-select-tag type="list" v-decorator="['sfZdgz', validatorRules.sfZdgz]" :trigger-change="true"
                                 dictCode="yes_no" placeholder="请选择是否重点关注"/>
            </a-form-item>
          </a-col>
        </a-row>
      </a-form>
