  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          add: "/testuser/testUser/add",
          edit: "/testuser/testUser/edit",
        }
      }
    },
    created () {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'name','sex','birthday'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'name','sex','birthday'))
      }
