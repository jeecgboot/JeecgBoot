...
public class WebLogAspect {
    public static Logger logger = LogManager.getLogger(WebLogAspect.class);
    private static int maxOutputLengthOfParaValue = 512;
    private static final String title = " -------- action report -------- ";
    ...
    public void doBefore(JoinPoint joinPoint) {
        ...
        sb.append("Ip     : ").append("Client[").append(IPUtil.getIpAddr(request)).append("]\n");
