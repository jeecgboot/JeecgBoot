...
// if
// (PathMatcherUtil.matches(Arrays.asList(SignAuthConfiguration.SIGN_URL_LIST),requestTemplate.path()))
// {
// try {
...
// }
// SortedMap<String, String> allParams =
// HttpUtils.getAllParams(requestTemplate.path(),queryLine,requestTemplate.body(),requestTemplate.method());
...
// requestTemplate.header(CommonConstant.X_TIMESTAMP,
...
// @Primary
// @Scope("prototype")
// public Encoder multipartFormEncoder(ObjectFactory<HttpMessageConverters>
// messageConverters) {
...
// final HttpMessageConverters httpMessageConverters = new
// HttpMessageConverters(this.getFastJsonConverter());
