...
public class NgAlainServiceImpl implements NgAlainService {
	...
	private JSONObject getPermissionJsonObject(SysPermission permission) {
		...
		else if (CommonConstant.MENU_TYPE_0.equals(permission.getMenuType())
				|| CommonConstant.MENU_TYPE_1.equals(permission.getMenuType())) {
			json.put("id", permission.getId());
			boolean flag = permission.getUrl() != null && (permission.getUrl().startsWith(CommonConstant.HTTP_PROTOCOL)
					|| permission.getUrl().startsWith(CommonConstant.HTTPS_PROTOCOL));
			if (flag) {
