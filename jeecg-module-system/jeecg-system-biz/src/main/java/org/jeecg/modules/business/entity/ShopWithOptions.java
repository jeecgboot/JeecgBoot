...
public class ShopWithOptions {
    ...
    /**是否客户激活*/
    @Excel(name = "是否客户激活", width = 15)
    @ApiModelProperty(value = "是否客户激活")
    private java.lang.Boolean isClientActive;
    /**店铺ID*/
    ...
    private java.lang.Boolean hasOptions;
}
