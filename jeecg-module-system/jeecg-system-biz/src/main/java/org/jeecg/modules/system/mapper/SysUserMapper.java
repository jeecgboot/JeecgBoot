...
public interface SysUserMapper extends BaseMapper<SysUser> {
	...
	void updateUserDepart(@Param("username") String username, @Param("orgCode") String orgCode,
			@Param("loginTenantId") Integer loginTenantId);
	 ...
	 * @return
	 */
	List<SysUserSysDepartModel> getUserByOrgCode(IPage page, @Param("orgCode") String orgCode,
			@Param("userParams") SysUser userParams);
	 ...
	 * @return
	 */
	IPage<SysUser> selectUserListByRoleId(Page<SysUser> page, @Param("roleId") String roleId,
