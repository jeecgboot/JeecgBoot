...
@Service
@Slf4j
public class SysGatewayRouteServiceImpl extends ServiceImpl<SysGatewayRouteMapper, SysGatewayRoute>
	...
	public void updateAll(JSONObject json) {
		...
		try {
			...
			// update-begin-author:taoyan date:20211025 for: oracle路由网关新增小bug
			// /issues/I4EV2J
