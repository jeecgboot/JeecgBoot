...
public interface ISysDictService extends IService<SysDict> {
	...
	// */
	// @Deprecated
	// public List<DictModel> queryTableDictItems(String table, String text, String
	// code,String keyword);
	 ...
	 */
	@Deprecated
	List<TreeSelectModel> queryTreeList(Map<String, String> query, String table, String text, String code,
	...
	/**
	 * 【JSearchSelectTag下拉搜索组件专用接口】 大数据量的字典表 走异步加载 即前端输入内容过滤数据
