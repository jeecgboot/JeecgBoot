...
public class FindsDepartsChildrenUtil {
	...
	// 部门树信息-树结构
	// private static List<SysDepartTreeModel> sysDepartTreeList = new
	// ArrayList<SysDepartTreeModel>();

	// 部门树id-树结构
	// private static List<DepartIdModel> idList = new ArrayList<>();

	/**
	 * queryTreeList的子方法 ====1===== 该方法是s将SysDepart类型的list集合转换成SysDepartTreeModel类型的集合
	 */
	 ...
	 */
	private static void getGrandChildren(List<SysDepartTreeModel> treeList, List<SysDepartTreeModel> recordList,
