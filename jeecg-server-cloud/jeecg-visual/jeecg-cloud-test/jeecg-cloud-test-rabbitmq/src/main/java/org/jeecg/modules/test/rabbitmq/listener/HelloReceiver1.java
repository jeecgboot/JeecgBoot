 ...
 *
 * RabbitMq接受者1 （@RabbitListener声明类上，一个类只能监听一个队列）
 *
 * @author: zyf
 * @date: 2022/04/21
 */
		...
		super.onMessage(baseMap, deliveryTag, channel, new MqListener<BaseMap>() {
			...
			public void handler(BaseMap map, Channel channel) {
				...
				try {
					...
					// requestHeaders.add("X-Access-Token",
					// "eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJleHAiOjE2MzExOTcyOTEsInVzZXJuYW1lIjoiYWRtaW4ifQ.N8mJvwzb4G0i3vYF9A2Bmf5cDKb1LDnOp1RwtpYEu1E");
					...
					// HttpEntity(requestBody, requestHeaders);
					// //post
					// ResponseEntity<String> responseEntity =
					// restTemplate.postForEntity("http://localhost:7002/test/getMessage",
